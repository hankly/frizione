...
/*crash patch start*/
    static protected boolean processStdin = true;
    static protected Vector fileList = new Vector(5);
/*crash patch end*/
...
/*crash patch start*/
        public IProxy(int type, String[] args)
        {
            this(type);
            this.args = args;
        }
...
/*crash patch start*/
    protected static void processFiles(Context cx, String[] args)
/*crash patch end*/
    {
...
/*crash patch start*/
    protected static void initJavaPolicySecuritySupport()
/*crash patch end*/
    {
        Throwable exObj;
        try {
